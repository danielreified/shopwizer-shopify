...
export default function UsageCappedEmail() {
  return (
    <Html>
      <Head>
        <Font
        ...
        <Container className="font-sans bg-white rounded-md">
          ...
          <Section className="text-center mt-[24px] mb-[40px]">
            ...
            <Text className="text-gray-700 text-[16px] mt-[8px] leading-[24px]">
              Your monthly usage cap has been reached. Shopwise will pause new recommendations until
              your next billing cycle resets.
            </Text>
          </Section>
          ...
          <Section className="text-center text-[14px] text-gray-500">
            <Text>
              Want uninterrupted insights? Upgrade to a higher tier and remove your monthly cap.
            </Text>
          </Section>
